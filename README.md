...
> ⚠️ Must be done in Safari — Chrome and other browsers on iPhone/iPad do not support PWA installation.
...
1. Click the install icon (⊕) in the address bar and follow the prompts
